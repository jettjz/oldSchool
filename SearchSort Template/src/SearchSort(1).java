...
public class SearchSort {
    ...
    public static void main(String[] args) {
        ...
        String[] options = {"Empty List", "Random List", "Add a Word", "Display the List", "Linear Search", "Binary Search", "Insertion Sort", "Bubble Sort", "Selection Sort", "Write to Text File", "Read from File", "Exit"};
        String option;
